...
public class GameData implements IStrategy{
    ...
    ///////////////////////////////
    // This function is designed return a score based on the amount of lives the user has left at the end.
    // **********BUG*********
    // As a result of the end condition being (lives <= 0): Score will always be 0.
    public int getScore() {
        //Commented Out: 
        //score = lives * 5;   <------------- BUG
        return score;
    ...
    public void shoot(float x, float y, ArrowTower tower){
        //Instantiates a new Missile at the x and y location of the Regular Tower, color is black
        ...
        int size = RandGen1.nextInt(15);     //int size = (int) (Math.random() * 10) + 5;
    ...
    public void shoot(float x, float y, BlueTower tower){
        //Instantiates a new Missile at the x and y location of the Blue Tower, color is blue
        ...
        //Finds a random number between 
        int size = RandGen2.nextInt(15);     //int size = (int) (Math.random() * 10) + 5;
        // Sets the size of the explosion to the random number
        f.setExplosionMaxSize(size);
        // Adds the explosion into the figures arraylist to be rendered.
        figures.add(f);
             ...
             switch(n)
             {
                 case 0:
                     ...
                     while(monsterElapsedTime > 1000)
                     {
                         ...
                         {
                        	 //This part is limits regular monsters to half the wave size
           ...
           for(int i = 0; i < figures.size()-2; i++)
           {
              for(int j = 0; j < figures.size()-1; j++)
              {
                 if(figures.get(i) instanceof BlueTower)
                 {
                    if(figures.get(j) instanceof RegularMonster)
                    {
                       ...
                       {
                           shoot((float)figures.get(j).getX() ,(float)figures.get(j).getY(), (BlueTower)figures.get(i));    
                       }
                 ...
                 } else if(figures.get(i) instanceof ArrowTower)
                 {
                     if(figures.get(j) instanceof RegularMonster)
                    {
                       if((figures.get(i)).collision(figures.get(j)))
                       {
                           shoot((float)figures.get(j).getX() ,(float)figures.get(j).getY(), (ArrowTower)figures.get(i));  
                       }
                    } else if(figures.get(j) instanceof FastMonster)
                    {
                        if((figures.get(i)).collision(figures.get(j)))
             ...
             for(int i = 0; i < figures.size()-2; i++)
             {
                   for(int j = 1; j < figures.size()-1; j++)
                   {
                       ...
                       {
                          if(((RegularMonster)figures.get(j)).contains((int)figures.get(i).getX(), (int)figures.get(i).getY()))
                          {
                       ...
                       {
                          if(((FastMonster)figures.get(j)).contains((int)figures.get(i).getX(), (int)figures.get(i).getY()))
                          {
                             figures.get(i).setState(GameFigure.STATE_DONE);
                             figures.get(j).updateHealth();
                          }
                       }else if(figures.get(i) instanceof Missile && figures.get(j) instanceof Boss){
                          if(((Boss)figures.get(j)).contains((int)figures.get(i).getX(), (int)figures.get(i).getY()))
                          {
                             figures.get(i).setState(GameFigure.STATE_DONE);
                             figures.get(j).updateHealth();
                          }
                       ...
                       {
                          if(((RegularMonster)figures.get(i)).contains((int)figures.get(j).getX(), (int)figures.get(j).getY()))
                          {
                       ...
                       {
                          if(((FastMonster)figures.get(i)).contains((int)figures.get(j).getX(), (int)figures.get(j).getY()))
                          {
                                figures.get(j).setState(GameFigure.STATE_DONE);
                                figures.get(i).updateHealth();
                          }
                       ...
                       {
                          if(((Boss)figures.get(i)).contains((int)figures.get(j).getX(), (int)figures.get(j).getY()))
                          {
                                figures.get(j).setState(GameFigure.STATE_DONE);
                                figures.get(i).updateHealth();
                          }
