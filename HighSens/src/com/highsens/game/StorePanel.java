...
// USE THIS INSTEAD (java.nio.file.Path;)
...
///////////////////////////////
    ...
    // static and final are two ways of saying that this is a constant public variable.
    ...
    private StoreAnimator animator;
    ...
    public StorePanel(StoreAnimator animator, GameData gameData) {
        ///////////////////////////////
        ...
        ///////////////////////////////
        // Commented out: Unsure what it does and game works without it (Watch for bugs)
        ...
        // Adds the map image from the images director with a distinct seperator and path
        mapImage = getStoreImage(imagePath + separator + "images" + separator
                + "map.png");
        // Adds the Regular Tower image from the images director with a distinct seperator and path
        ArrowTowerImage = getStoreImage(imagePath + separator + "images" + separator
                + "ArrowTower.png");
        // Adds the Blue Tower image from the images director with a distinct seperator and path
        BlueTowerImage = getStoreImage(imagePath + separator + "images" + separator
                + "BlueTower.png");
        ///////////////////////////////
    }
    ...
    public static Image getStoreImage(String fileName) {
    ...
    public void storeRender() {
        ...
        if (dbImage == null) {
            ...
            dbImage = createImage(GamePanel.PWIDTH, GamePanel.PHEIGHT);
        ...
        synchronized (gameData.figures) {
            ...
            if(gameData.lives <= 0)
            {
                ...
                ///////////////////////////////
                // Fills the screen from the origin (Top Left Corner) to (1000, 1000) with black
                ...
                ///////////////////////////////
                // Renders Red Text in the specified Font to print GAME OVER MAN!!!
                ...
                ///////////////////////////////
                // Renders White Text in the specified Font to print the amount of waves and the score
            ...
            //    less than the size of the figure object within the gameData object
            for (int i = 0; i < gameData.figures.size(); i++) {
                
                // get(i): Function gets the object from the collection of figures (images) within the gamedata
                f = (GameFigure) gameData.figures.get(i);
    ...
    public void printScreen() {
        ...
        // PLEASE WORK
        try {
            // getGraphics() is a function within the Graphics library imported at top
    ...
    ///////////////////////////////
    // Commented out: It worked before, but i dont believe this is necessary (watch for bugs)
    ///////////////////////////////
