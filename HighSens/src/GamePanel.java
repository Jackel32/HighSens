...
///////////////////////////////
    ...
    public GamePanel(Animator animator, GameData gameData) {
        ...
        mapImage = getImage(imagePath + separator + "images" + separator
                + "map.png");
        // Adds the Regular Tower image from the images director with a distinct seperator and path
        ArrowTowerImage = getImage(imagePath + separator + "images" + separator
                + "ArrowTower.png");
        // Adds the Blue Tower image from the images director with a distinct seperator and path
        BlueTowerImage = getImage(imagePath + separator + "images" + separator
                + "BlueTower.png");
        
        RegularMonsterImage = getImage(imagePath + separator + "images" + separator
                + "RegularMonster1.png");
        
        FastMonsterImage = getImage(imagePath + separator + "images" + separator
                + "fastMonster1.png");
